...
/**
 * Preferences manager for persisting light and dark mode preferences in Rescuer App.
 */
class ThemePreferences(context: Context) {
    private val prefs = context.getSharedPreferences("rescuer_theme_prefs", Context.MODE_PRIVATE)
